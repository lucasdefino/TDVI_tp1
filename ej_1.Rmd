...
```{r}
df = read.csv('~/Documents/UTDT/ano3_semestre2/TDVI/TP1/CO2 Emissions.csv')

mayores_a_200gkm <- df$CO2.Emissions.g.km > 200
mayores_a_200gkm <- as.integer(as.logical(mayores_a_200gkm))

df$Impuesto_14.75 <- mayores_a_200gkm
```

### 5.

```{r}
write.csv(df, "~/Documents/UTDT/ano3_semestre2/TDVI/TP1/CO2 Emissions Transformado.csv", row.names=FALSE)
```
